...
<head>
	<title>Tuiter</title>
	<meta charset="utf-8">
	<link rel="stylesheet" type="text/css" href="tuiter.css">
    <script type="text/javascript" src="java.js"></script>
</head>
<body onload="MostrarTuits()">
	<div id="derecha">
        <div id="iconos">
            <button id="imagen" type="submit">
            <img src="imagenes/logo.png" width="30px" height="25px"></img>
            </button>
            <br><br>
            <button id="inicio" type="submit"onclick="document.location.reload();">
            ...
            <br><br>
            <button id="perfil" type="submit" onclick="location.href='./perfi.php'">
	...
	<div id="centro">
     <div id="superior">
        <div id="in">Inicio</div>
        <div id="usuarioNombre"><?php echo "@".$user ?></div>
    </div>
     <div id="Caja">
        <textarea id="Tweet" rows="7" cols="80" placeholder="¿Qué está pasando?"></textarea>
        <div id="advertencia"></div>
        <br>
        <div id="CajaBoton">
        <button id="tuitear2" type="submit" onclick="Tuitear()">
            Tuitear
        </button>
        </div>
        <br>
